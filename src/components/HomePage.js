    ...
    <HomeContainer>
      ...
      <HeroSection>
        <HeroContent>
          ...
          <ButtonGroup>
            <Button href="#break-cycle" variant="white" size="large">
              See the Cycle
            </Button>
                         <Button href="/checkout?type=single" variant="primary" size="large">
               Singles Assessment – $49
             </Button>
             <Button href="/checkout?type=couples" variant="secondary" size="large">
        ...
        <SectionContent>
          ...
          <Grid className="cols-3">
            ...
            >
              ...
              <Button href="/free-assessment" style={{ 
                background: '#ffd700', 
                color: '#333', 
                marginTop: '1rem' 
              }}>
            ...
            >
              ...
              <CardList>
                ...
                <CardListItem>Action steps to spot red flags early and choose better</CardListItem>
                             ...
                             <Button href="/checkout?type=single" variant="primary" size="large" style={{ marginTop: '1rem' }}>
                 Start Singles — $49
               </Button>
            </Card>
            ...
            >
              ...
              <CardList>
                ...
                <CardListItem>Clear guidance on strengths, friction points, and pacing</CardListItem>
                             ...
                             <Button href="/checkout?type=couples" variant="primary" size="large" style={{ marginTop: '1rem' }}>
                 Start Couples — $79
               </Button>
            </Card>
          </Grid>
        ...
        <SectionContent>
          ...
          <div style={{ textAlign: 'center', marginTop: '2.5rem' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <Button href="/checkout?type=couples" variant="primary" size="large">
                Start Couples — $79
              </Button>
            </div>
          </div>
